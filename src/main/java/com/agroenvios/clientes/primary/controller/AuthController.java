...
import com.agroenvios.clientes.primary.dto.auth.*;
import com.agroenvios.clientes.primary.service.AuthService;
import com.agroenvios.clientes.primary.service.PasswordResetService;
...
public class AuthController {
    ...
    public ResponseEntity<Boolean> validateSession(HttpServletRequest request) {
        return authService.validateSession(request);
    }
